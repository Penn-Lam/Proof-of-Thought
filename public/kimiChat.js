...
async function analyzeThinking(dialog) {
    ...
    {
        "nodes": [
            {"id": "1", "name": "思维点1", "symbolSize": 60, "text": "思维点1的详细描述"},
            {"id": "2", "name": "思维点2", "symbolSize": 70, "text": "思维点2的详细描述"},
            ...
        ],
        "links": [
            {"source": "1", "target": "2", "value": 10, "name": "关联说明", "text": "关联说明的详细描述"},
            ...
        ]
    ...
    # 输出内容描述：
        ...
        - symbolSize：表示该思维点的重要性，取值范围必须在【50-150】之间

        2. links（边）：每条边表示两个思维点之间的逻辑或因果关系。每条边需包含：
        - source：起始节点 id
        - target：目标节点 id
        - name：这两个思维点之间的关联说明（如“因果关系”、“递进关系”、“补充说明”等）
    ...
    # 示例:
        ...
        <assistant_response> 
            ...
            "nodes": [
                ...
                "name": "黑客松主题解读",
                "symbolSize": 80,
                "text": "从黑客松主题中提取出“何以为人”的哲学命题，强调AI无法替代人的意义构建与情感深度，作为整个思考的起点。"
                },
                {
                "id": "2",
                "name": "文章触发思考",
                "symbolSize": 60,
                "text": "阅读关于‘AI礼仪’的文章后，受到‘Proof of Thought’概念启发，意识到人类思考的痕迹是AI难以模仿的关键。"
                },
                {
                "id": "3",
                "name": "仪式感表达构想",
                "symbolSize": 100,
                "text": "设想通过表单与链接分享机制，将人的思考过程具象化为一种‘仪式’，强调内容分享中的尊重与责任。"
                },
                {
                "id": "4",
                "name": "技术实现路径",
                "symbolSize": 70,
                "text": "计划基于已有的 URL 转换项目进行技术嫁接，引入表单、数据存储与可视化展示，构建完整的体验链路。"
                },
                {
                "id": "5",
                "name": "多场景延展",
                "symbolSize": 110,
                "text": "提出将Proof of Thought应用于AI生成图像、代码、对话、推荐等场景，并为每种使用情境设计引导性表单。"
                },
                {
                "id": "6",
                "name": "“思想钢印”设计",
                "symbolSize": 60,
                "text": "构建具有审美与情感的视觉符号系统，为用户的原创内容生成独一无二的“思想印记”，加强表达的个体属性。"
                },
                {
                "id": "7",
                "name": "人的价值证明",
                "symbolSize": 60,
                "text": "将PoT流程升华为对人类创造性、情感与道德判断的体现，回应“AI无法取代人”的终极命题。"
                }
            ],
            "links": [
                {
                ...
                "target": "2",
                "name": "因果关系",
                "text": "黑客松主题引发对AI与人的边界问题的关注，进而被文章中的PoT概念触发思考"
                },
                {
                "source": "2",
                "target": "3",
                "name": "递进关系",
                "text": "在PoT概念基础上，用户提出构建带有仪式感的分享方式，用以强化人的思考痕迹"
                },
                {
                "source": "3",
                "target": "4",
                "name": "补充说明",
                "text": "将表达构想转化为技术实践路径，提出基于已有项目进行改造的具体方向"
                },
                {
                "source": "3",
                "target": "5",
                "name": "横向扩展",
                "text": "进一步思考不同AI使用情境中的PoT可能形式，提出结构化表单引导思考"
                },
                {
                "source": "3",
                "target": "6",
                "name": "递进关系",
                "text": "为了增强PoT的仪式感与独特性，构思视觉化的‘思想钢印’展示机制"
                },
                {
                "source": "5",
                "target": "6",
                "name": "补充说明",
                "text": "不同PoT应用场景促使‘钢印’设计需具备多样性与个性化呈现能力"
                },
                {
                "source": "4",
                "target": "7",
                "name": "服务目标",
                "text": "技术手段最终目的是承载用户PoT行为，达成对人类价值的表达与证明"
                },
                {
                "source": "6",
                "target": "7",
                "name": "递进关系",
                "text": "‘思想钢印’作为人类独特性可视化的象征，强化对AI无法复制人的价值的呈现"
                },
                {
                "source": "5",
                "target": "7",
                "name": "共同指向",
                "text": "多样化场景中的PoT实践共同服务于表达人的不可替代性"
                }
            ]
            }
